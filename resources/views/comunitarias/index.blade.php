  ...
  <body id="page-top">
    ...
    <section class="content-section bg-light teste" id="">
      <div class="container text-center">
        <h1 class="mb-4"><strong>Eixo 5 - Ação Comunitária        </strong><br><br></h1>
        <div class="row md-3">
          <div class="col">
            <p class="lead mb-5">


                A Ação Comunitária vai além da prestação de serviço à comunidade, mas engloba a integração da escola e da família na perspectiva de fortalecer a participação social, contribuindo para a garantia da promoção social das pessoas da comunidade.                    </div>
